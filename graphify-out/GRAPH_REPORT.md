...
## Corpus Check
- 22 files · ~151,966 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2172 nodes · 5309 edges · 153 communities (111 shown, 42 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 492 edges (avg confidence: 0.8)
...
9. `FonctionEligibleService` - 31 edges
10. `cn()` - 30 edges
...
### Community 1 - "Misc"
Cohesion: 0.06
Nodes (52): BeneficiaireApi, FonctionEligibleController, GetMapping, PatchMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor (+44 more)

### Community 2 - "Misc"
Cohesion: 0.06
Nodes (21): AccessDeniedException, FichierImportInvalideException, PieceJointeIntrouvableException, ProcessusMensuelExisteDejaException, ProcessusMensuelIntrouvableException, ProcessusMensuelNonModifiableException, FonctionEligibleBeneficiairesActifsException, FonctionEligibleCodeDejaUtiliseException (+13 more)

### Community 3 - "Misc"
Cohesion: 0.05
Nodes (47): EnrolementController, GetMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController (+39 more)
...
### Community 5 - "Com"
Cohesion: 0.10
Nodes (29): ImportErreurDto, AllArgsConstructor, Builder, Data, NoArgsConstructor, BeneficiaireImportService, AuditService, AuthenticatedUserService (+21 more)
...
Cohesion: 0.17
Nodes (4): FonctionEligibleIntrouvableException, Transactional, GrilleTarifaireServiceTest, Test

### Community 11 - "Misc"
Cohesion: 0.10
Nodes (19): ActionAdminNonAutoriseeException, EmailUtilisateurDejaUtiliseException, MatriculeUtilisateurDejaUtiliseException, RoleInvalideException, UtilisateurIntrouvableException, AllArgsConstructor, Builder, Getter (+11 more)

### Community 12 - "Com"
Cohesion: 0.09
Nodes (21): BeneficiaireIdentiteDto, AuditService, AuthenticatedUserService, EligibiliteService, EtapeWorkflowRepository, EvenementClotureService, ExtendWith, GrilleTarifaireApi (+13 more)
...
### Community 14 - "Com"
Cohesion: 0.08
Nodes (26): BeneficiaireDocumentDto, BeneficiaireDotationDto, BeneficiaireIdentiteDto, AjustementLigneEtatDto, AuditService, AuthenticatedUserService, EligibiliteService, EtapeWorkflowRepository (+18 more)

### Community 15 - "Com"
Cohesion: 0.14
Nodes (14): Transactional, BeneficiaireServiceTest, AuditService, AuthenticatedUserService, Beneficiaire, BeneficiaireRepository, EligibiliteService, ExtendWith (+6 more)

### Community 16 - "Com"
Cohesion: 0.08
Nodes (19): MotifRejetObligatoireException, DateDebutGrilleAnterieureException, DecisionGrilleInvalideException, GrilleEnAttenteDrhExistanteException, GrilleIntrouvableException, GrilleNonActiveException, GrilleNonEnAttenteDrhException, GrilleTarifaireListeLigneDto (+11 more)
...
### Community 25 - "Com"
Cohesion: 0.16
Nodes (11): BeneficiaireApiImpl, BeneficiaireDotationDto, BeneficiaireIdentiteDto, BeneficiaireRepository, RequiredArgsConstructor, Service, BeneficiaireApiImplTest, BeneficiaireRepository (+3 more)

### Community 26 - "Misc"
Cohesion: 0.20
Nodes (14): AuditService, Getter, Setter, LoginRequestDto, UtilisateurRepository, AuthService, PasswordEncoder, RequiredArgsConstructor (+6 more)

### Community 27 - "Com"
Cohesion: 0.13
Nodes (17): BeneficiaireRepository, StatutEnum, CLOTURE, EN_ATTENTE_CRH, EN_ATTENTE_DRH, EN_COURS_ARH, RETOURNE, AllArgsConstructor (+9 more)

### Community 28 - "Com"
Cohesion: 0.18
Nodes (3): ProcessusMensuel, Test, ValiderProcessusResponseDto
...
### Community 34 - "Misc"
Cohesion: 0.19
Nodes (13): GetMapping, PatchMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController (+5 more)
...
### Community 37 - "Com"
Cohesion: 0.16
Nodes (15): SignatureService, AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table (+7 more)

### Community 38 - "Misc"
Cohesion: 0.18
Nodes (12): BeneficiaireIntrouvableException, BeneficiaireService, AuditService, AuthenticatedUserService, Beneficiaire, BeneficiaireRepository, EligibiliteService, GrilleTarifaireApi (+4 more)
...
Cohesion: 0.23
Nodes (7): GrilleNonModifiableException, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter, ModifierGrilleTarifaireRequestDto
...
### Community 56 - "Misc"
Cohesion: 0.36
Nodes (4): BeneficiaireDotationDto, Transactional, DeclencherProcessusRequestDto, ProcessusMensuelResponseDto
...
- **Why does `FonctionEligibleService` connect `Misc` to `Misc`, `Com`, `Com`, `Com`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `ProcessusMensuelService` connect `Com` to `Com`, `Misc`, `Audit Securite Owasp V1`, `Com`, `Com`, `Com`, `Misc`, `Sprint 3.4`, `Com`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `AuditService` connect `Misc` to `Package.Json`, `Misc`, `Package.Json`, `Contrats Api Dotations V3`, `Misc`, `Com`?**
