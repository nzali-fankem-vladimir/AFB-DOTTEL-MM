# Graph Report - afb-dottel  (2026-07-23)

## Corpus Check
- 165 files · ~86,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1130 nodes · 2828 edges · 55 communities (43 shown, 12 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 382 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb7cbfef`
...
- ProcessusMensuelService.java
- IdentifiantsInvalidesException

## God Nodes (most connected - your core abstractions)
1. `Utilisateur` - 63 edges
2. `ProcessusMensuel` - 39 edges
3. `LigneEtatMensuel` - 33 edges
4. `FonctionEligible` - 32 edges
5. `FonctionEligibleRepository` - 32 edges
6. `ProcessusMensuelServiceTest` - 32 edges
7. `BeneficiaireRepository` - 31 edges
8. `Beneficiaire` - 30 edges
9. `GrilleTarifaire` - 27 edges
10. `GlobalExceptionHandler` - 27 edges
...
Cohesion: 0.06
Nodes (56): EnrolementController, GetMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController (+48 more)
...
Cohesion: 0.17
Nodes (13): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, Utilisateur (+5 more)
...
Cohesion: 0.14
Nodes (17): Component, Override, RoleJwtAuthenticationConverter, Configuration, PasswordEncoder, SecurityConfig, Test, RoleJwtAuthenticationConverterTest (+9 more)

### Community 11 - "EnrolementController.java"
Cohesion: 0.07
Nodes (44): GetMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController, UtilisateurAdminController (+36 more)
...
Cohesion: 0.06
Nodes (45): BeneficiaireController, GetMapping, MultipartFile, PatchMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor (+37 more)
...
Cohesion: 0.06
Nodes (47): PatchMapping, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController, ProcessusMensuelController (+39 more)
...
Cohesion: 0.10
Nodes (26): UtilisateurConnecteIntrouvableException, ImportErreurDto, AllArgsConstructor, Builder, Data, NoArgsConstructor, ImportRapportDto, AllArgsConstructor (+18 more)
...
### Community 41 - "AuthController.java"
Cohesion: 0.10
Nodes (22): DeclencherProcessusRequestDto, Getter, Setter, Beneficiaire, AllArgsConstructor, Builder, Entity, Getter (+14 more)

### Community 42 - "GlobalExceptionHandler.java"
Cohesion: 0.09
Nodes (14): DecisionGrilleInvalideException, FonctionEligibleIntrouvableException, GrilleEnAttenteDrhExistanteException, GrilleIntrouvableException, GrilleNonEnAttenteDrhException, GrilleNonModifiableException, MotifRejetObligatoireException, GrilleTarifaireRepository (+6 more)

### Community 43 - "ProcessusMensuelController.java"
Cohesion: 0.26
Nodes (8): AjustementLigneEtatDto, Getter, Setter, Getter, Setter, PatchProcessusRequestDto, Test, ProcessusMensuelServiceTest

### Community 44 - "JwtUtil"
Cohesion: 0.16
Nodes (19): GrilleHistoriqueLigneDto, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter, GrilleTarifaire, AllArgsConstructor (+11 more)

### Community 45 - ".genererToken"
Cohesion: 0.23
Nodes (7): DocumentService, RequiredArgsConstructor, Service, Transactional, ResultatEcartMensuel, Test, Document

### Community 47 - "UtilisateurRepository"
Cohesion: 0.25
Nodes (11): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, PieceJointe (+3 more)

### Community 48 - "ResultatAjustementDto"
Cohesion: 0.36
Nodes (6): HistoriqueGrilleTarifaireResponseDto, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter

### Community 49 - "BeneficiaireExcluDto"
Cohesion: 0.42
Nodes (8): AllArgsConstructor, Builder, Entity, Getter, NoArgsConstructor, Setter, Table, LigneEtatMensuel

### Community 50 - "PatchProcessusResponseDto"
Cohesion: 0.52
Nodes (6): CreerGrilleTarifaireRequestDto, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter

### Community 51 - "ProcessusMensuelResponseDto"
Cohesion: 0.52
Nodes (6): DecisionGrilleTarifaireRequestDto, AllArgsConstructor, Builder, Getter, NoArgsConstructor, Setter

### Community 52 - "NotificationServiceStub"
Cohesion: 0.47
Nodes (4): Override, Service, NotificationServiceStub, Slf4j

### Community 53 - "ProcessusMensuelService.java"
Cohesion: 0.12
Nodes (12): ProcessusMensuelIntrouvableException, ProcessusMensuelNonModifiableException, EtapeWorkflowRepository, LigneEtatMensuelRepository, UtilisateurRepository, RequiredArgsConstructor, Service, Transactional (+4 more)

### Community 54 - "IdentifiantsInvalidesException"
Cohesion: 0.52
...
- **Why does `Utilisateur` connect `GrilleTarifaire` to `Utilisateur`, `.confirmer`, `ProcessusMensuel`, `AuthController.java`, `EnrolementController.java`, `ProcessusMensuelController.java`, `.genererToken`, `ProcessusMensuel`, `NotificationServiceStub`, `ProcessusMensuelService.java`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `FonctionEligibleRepository` connect `.confirmer` to `ProcessusMensuel`, `GlobalExceptionHandler.java`, `ProcessusMensuelController.java`, `ProcessusMensuel`, `.genererToken`, `UtilisateurRepository`, `ExceptionHandler`, `ProcessusMensuelService.java`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `UtilisateurRepository` connect `ProcessusMensuelService.java` to `Utilisateur`, `ProcessusMensuel`, `GrilleTarifaire`, `EnrolementController.java`, `ProcessusMensuelController.java`, `.genererToken`?**
